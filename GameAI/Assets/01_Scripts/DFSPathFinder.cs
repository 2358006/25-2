...
public class DFSPathFinder : MonoBehaviour
{
    ...
    //  - start : 시작지점을 설정
    //  - end : 도착지점을 설정
    public void SetStartLocation(Vector2Int start)  //시작지점을 설정하는 메소드
    {
        startLocation = start;
    }

    public void SetEndLocation(Vector2Int end)  //도착지점을 설정하는 메소드
    {
        endLocation = end;
    }
    // DFS 탐색 실행 메소드
        ...
        */
        foreach (Vector2Int dir in vDirections)
        {
            ...
            /*
                ...
                path에는 neighbor → ... → end 순서로 좌표가 들어있다
            ...
            */
            ...
            /*
                ...
                current → neighbor → ... → end 순서로 경로가 구성된다
